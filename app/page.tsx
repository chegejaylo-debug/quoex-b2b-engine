          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 md:p-8">
            <div className="border-b pb-4 mb-6">
              ...
              <h2 className="text-2xl font-black text-gray-900 mt-0.5">
                Submit Multi-Item Supply Requirements
              </h2>
              <p className="text-xs text-gray-500 mt-1">
                Specify custom compounds or multi-SKU layouts. Agents respond within 120 minutes.
              </p>
            </div>
            ...
            <form onSubmit={submitGlobalRfqBoardForm} className="space-y-4">
              <div>
                <label className="text-xs font-black text-gray-700 block mb-1">
                  Comprehensive Manifest Requirements Details
                </label>
                <textarea
                  required
                  ...
                  onChange={(e) =>
                    setRfqForm({ ...rfqForm, description: e.target.value })
                  }
                />
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-black text-gray-700 block mb-1">
                    Target Procurement Cap Budget ({currency})
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setRfqForm({ ...rfqForm, targetBudget: e.target.value })
                    }
                  />
                </div>
                <div>
                  <label className="text-xs font-black text-gray-700 block mb-1">
                    Project Site Urgency Windows
                  </label>
                  <select
                    ...
                    onChange={(e) =>
                      setRfqForm({ ...rfqForm, urgency: e.target.value })
                    }
                  >
              ...
              <button
                type="submit"
                className="w-full bg-orange-500 hover:bg-orange-600 text-white text-xs font-black py-3 rounded-lg uppercase tracking-wider transition shadow-md"
              >
              ...
              <div className="flex-1">
                {loading ? (
                  <div className="text-center py-24 bg-white rounded-xl border border-gray-100">
                    ...
                    <p className="text-xs font-bold text-gray-400">
                      Synchronizing Live Supabase B2B Warehouses...
                    </p>
                  </div>
                ) : inventory.length === 0 ? (
                  ...
                  <>
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                      {inventory.map((product) => (
                        <div
                          key={product.id}
                          className="bg-white rounded-xl border border-gray-100 p-3 flex flex-col group relative shadow-xs hover:shadow-md transition"
                        >
                          ...
                          <div className="h-36 w-full bg-gray-50 rounded-lg overflow-hidden relative flex items-center justify-center mb-2">
                            ...
                            <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition flex items-center justify-center">
                              <button
                                ...
                                className="bg-white text-gray-900 text-[10px] font-black px-2.5 py-1.5 rounded shadow flex items-center gap-1"
                              >
